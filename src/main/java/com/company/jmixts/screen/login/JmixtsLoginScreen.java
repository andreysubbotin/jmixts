package com.company.jmixts.screen.login;
...
@UiController("jmixts_LoginScreen")
@UiDescriptor("jmixts-login-screen.xml")
@Route(path = "login", root = true)
public class JmixtsLoginScreen extends Screen {
